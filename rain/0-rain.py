#!/usr/bin/python3
""" Calculating how many square units of water will be retained after it rains given a list of non-negative integers represent the heights of walls with unit width 1 as if viewing the cross-section of a relief map"""
